...
public class JDBC02_execute_executeUpdate {
   ...
   C) - executeUpdate() metodu ise INSERT, Update gibi DML islemlerinde yaygin kullanilir.
      ...
      */
        ...
        //String dropTable = "DROP TABLE isciler"; // burada silme islemi yapiyoruz
        ...
        /*
        ORNEK 2: isciler adinda bir tablo olusturunuz id int birim VARCHAR(10), maas int
         */
...
//        /*
//        ORNEK3: isciler tablosuna yeni bir kayit (80, 'ARGE', 4000) ekleyelim
//         */
//
...
//         System.out.println(count + " satir eklendi!");
         ...
         /*
         Ayri ayri sorgular ile veritabanina tekrar tekrar ulasmak islemlerin yavas yapilmasina
         yol acar. 10000 tane veri kaydi yapildigi dusunuldugunde bu kotu bir yaklasimdir.
          */
...
//         metodu ile veritabanina bir kere gonderilebilir. executeBatch() metodu bir int [] dizi
//         dondurur. Bu dizi her bir ifade sonucunda etkilenen satir sayisini gosterir.
//         */
//
//
...
//
        ...
        /*
        ORNEK5: isciler tablosundaki maasi 5000'den az olan iscilerin maasina %10 zam yapiniz
         */
